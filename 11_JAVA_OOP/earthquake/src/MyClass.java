/**
 * Created by major on 14.02.17.
 *
 * Using for check quiz answers, because coursera don't want
 * to submit it as long as i won't pay
 * Week 2: Objects, memory models, and scope
 */
